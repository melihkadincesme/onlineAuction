...
$(document).ready(function(){
  ...
  <div>
	...
	try{
		...
		String testq = "SELECT * FROM item i WHERE i.check_live=1 and i.available=1 and i.itemID not in(SELECT i.itemID FROM item i where i.seller_email=?) order by initial_price ASC";
